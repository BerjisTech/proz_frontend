    ...
    return (
        <div className="">
            ...
            {chats.length === 0 ? (
                ...
                return (
                    <a href={`chat/${index}`} key={index} id={index} className="flex items-center px-3 py-2 text-sm transition duration-150 ease-in-out border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none">
