...
const Notifications = () => {
    return (
        <div>
            <a className="text-green-800 bg-inherit mx-2 d-flex align-items-center justify-content-center" id="notificationsDropdown" href="/#/dashboard/*" data-bs-toggle="dropdown" aria-expanded="false">
                <FiBell className="text-xl text-orange-400" />
                <span className="position-relative top-0 start-0 p-1 translate-middle badge rounded-pill bg-danger">+99 <span className="visually-hidden">unread messages</span></span>
            </a>
